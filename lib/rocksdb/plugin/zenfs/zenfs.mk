...
# Only rewrite version.h when it differs: touching it on every parse makes the
# included .cc.d dependency files stale, and make restarts itself forever.
$(shell grep -qs 'ZENFS_VERSION "1.0"' $(ZENFS_ROOT_DIR)/fs/version.h || printf '#pragma once\n#define ZENFS_VERSION "1.0"\n' > $(ZENFS_ROOT_DIR)/fs/version.h)
